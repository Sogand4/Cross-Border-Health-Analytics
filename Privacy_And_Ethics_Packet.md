...
All three Clause→Control→Test bundles include clear enforcement points and red-bar pytest evidence (conceptual). Each guardrail is tracked with a 🟡 status (“Designed / Pending Enforcement”) and is actionable in future CI.
